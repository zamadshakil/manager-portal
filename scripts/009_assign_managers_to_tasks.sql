-- ============================================================================
-- Update `assign_task_to_team` to allow assigning tasks to all members of the team,
-- including the manager. This fixes the issue where clicking "Whole team" 
-- excluded the manager from being assigned.
-- ============================================================================
