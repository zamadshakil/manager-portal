/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=showcase-site/wrangler.jsonc showcase-site/worker-configuration.d.ts` (hash: 2e0208682ef791256698dcfff3c1d7e4)
// Runtime types generated with workerd@1.20260903.1 2026-09-04 nodejs_compat
interface __BaseEnv_Env {
	LEAD_RATE_LIMIT: RateLimit;
	ASSETS: Fetcher;
	NEXT_PUBLIC_SITE_URL: "https://showcase.zamdevai.com";
	FUNNEL_ALTERNATE_ORIGIN: "https://hierarchia-showcase.zamadshakil.workers.dev";
	BREVO_FUNNEL_AUDIT_LIST_ID: "17";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SITE_URL" | "FUNNEL_ALTERNATE_ORIGIN" | "BREVO_FUNNEL_AUDIT_LIST_ID" | "FUNNEL_FORMS_ENABLED" | "NODE_ENV" | "BREVO_API_KEY">> {}
}
