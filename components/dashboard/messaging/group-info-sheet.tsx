...
export function GroupInfoSheet({ open, conversation, currentUserId, profiles, onClose, onClearHistory, onGroupUpdated, onDeleteConversation }: GroupInfoSheetProps) {
